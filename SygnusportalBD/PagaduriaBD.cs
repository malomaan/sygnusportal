...
namespace SygnusportalBD
{
    ...
    /// Create date: Feb 10 2020 10:41AM
    ...
    public class PagaduriaBD
    {
        ...
        /// Author     : MARCO ANTONIO MARTINEZ LOPEZ
        /// Create date: Feb 10 2020 10:41AM
        /// Método que permite insertar en la tabla Pagaduria capa BD
        /// </summary>
        // ******************* = Método Insert = ******************************
        public void Pagaduria_Insert(string pag_codigo, string pag_nit, int pag_dv, string pag_nombre, string pag_direccion, string ciu_codigo, string pag_telefonos, string pag_url, string pag_mail, string pag_logo, string pag_urlsygnus, string pag_color, int tpa_id, string emp_nit, int ent_id, bool pag_activa, string pag_fax)
        {
            try
            {
                BD.Pagaduria_Insert(pag_codigo, pag_nit, pag_dv, pag_nombre, pag_direccion, ciu_codigo, pag_telefonos, pag_url, pag_mail, pag_logo, pag_urlsygnus, pag_color, tpa_id, emp_nit, ent_id, pag_activa, pag_fax);
                BD.SaveChanges();
            }
            catch (Exception Ex)
            {
        ...
        /// Author     : MARCO ANTONIO MARTINEZ LOPEZ
        /// Create date: Feb 10 2020 10:41AM
        /// Método que permite actualizar en la tabla Pagaduria capa BD
        /// </summary>
        // ******************* = Método Update = ******************************
        public void Pagaduria_Update(int pag_id, string pag_codigo, string pag_nit, int pag_dv, string pag_nombre, string pag_direccion, string ciu_codigo, string pag_telefonos, string pag_url, string pag_mail, string pag_logo, string pag_urlsygnus, string pag_color, int tpa_id, string emp_nit, int ent_id, bool pag_activa, string pag_fax)
        {
            try
            {
                BD.Pagaduria_Update(pag_id, pag_codigo, pag_nit, pag_dv, pag_nombre, pag_direccion, ciu_codigo, pag_telefonos, pag_url, pag_mail, pag_logo, pag_urlsygnus, pag_color, tpa_id, emp_nit, ent_id, pag_activa, pag_fax);
                BD.SaveChanges();
            }
            catch (Exception Ex)
            {
        ...
        /// Author     : MARCO ANTONIO MARTINEZ LOPEZ
        /// Create date: Feb 10 2020 10:41AM
        /// Método que permite eliminar en la tabla Pagaduria capa BD
        /// </summary>
        // ******************* = Método Delete = ******************************
        ...
        /// Author     : MARCO ANTONIO MARTINEZ LOPEZ
        /// Create date: Feb 10 2020 10:41AM
        /// Método que permite listar de la tabla Pagaduria capa BD
        /// </summary>
        // ******************* = Método List = ******************************
        public List<Pagaduria_List_Result> Pagaduria_List(int pag_id)
        {
            try
            {
                var Pagaduria = (from TPagaduria in BD.Pagaduria_List(pag_id) select TPagaduria).ToList();
                return Pagaduria;
            }
            catch (Exception Ex)
            {
        ...
        /// <summary>
        /// Procedimiento que muestra el listado se pagadurías activas y sus estados capa BD
        /// </summary>
        /// <returns></returns>
        public List<Pagaduria_ListActivasPeriodos_Result> Pagaduria_ListActivasPeriodos()
        {
            try
            {
                var Pagaduria = (from TPagaduria in BD.Pagaduria_ListActivasPeriodos() select TPagaduria).ToList();
                return Pagaduria;
            }
            catch (Exception Ex)
            {
        ...
        /// <summary>
        /// Procedimiento que muestra el listado se pagadurías activas por Nombres y sus estados capa BD
        /// </summary>
        /// <returns></returns>
        public List<Pagaduria_ListActivasPeriodos_Nombre_Result> Pagaduria_ListActivasPeriodos_Nombre(string pag_nombve)
        {
            try
            {
                var Pagaduria = (from TPagaduria in BD.Pagaduria_ListActivasPeriodos_Nombre(pag_nombve) select TPagaduria).ToList();
                return Pagaduria;
            }
            catch (Exception Ex)
            {
